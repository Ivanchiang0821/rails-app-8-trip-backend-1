class ApplicationController < ActionController::Base
  ...
  def text_search(keyword, option)
    ...
    search_option = option == "景點|attractions" ? "景點" : option == "餐廳" ? "餐廳|美食|小吃|食物" : option == "購物" ? "便利商店|超市|百貨公司" : ""
  ...
  def nearby_search(lat, lng, option)
    ...
    keyword = option == "景點" ? "景點|attractions" : option == "餐廳" ? "餐廳|美食|小吃|食物" : option == "購物" ? "便利商店|超市|百貨公司" : ""
