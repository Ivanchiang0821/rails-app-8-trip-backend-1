class ApplicationController < ActionController::Base
  ...
  def text_search(keyword, option)
    ...
    search_option = option == "景點" ? "景點|attractions|sightseeing" : option == "餐廳" ? "餐廳|美食|小吃|食物|Food" : option == "購物" ? "便利商店|超市|百貨公司|Shopping" : ""
  ...
  def nearby_search(lat, lng, option)
    ...
    keyword = option == "景點" ? "景點|attractions|sightseeing" : option == "餐廳" ? "餐廳|美食|小吃|食物|Food" : option == "購物" ? "便利商店|超市|百貨公司|Shopping" : ""
